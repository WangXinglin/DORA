...
export CONFIG=/mnt/public/usr/yourpath/search-and-learn/recipes/Llama-3.2-1B-Instruct/rebase_qwen.yaml
...
export output_dir=/mnt/public/usr/yourpath/search-and-learn/result/MATH500/Qwen2.5-Math-PRM-7B/Llama-3.2-1B-Instruct/rebase
